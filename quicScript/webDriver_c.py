...
quicdir = "/home/quic/quicLossExp/quicPLT/PLT0411/"

def writeToFile(path, data):
    with open(path, 'a') as f:
        f.write("%s" %data)

def visitC(type, times, dt, loss, delay, quicdir=quicdir):
    ...
    option.add_argument("--host-resolver-rules=MAP www.example.org:443 yuyj.biz:6120") #lossclassify
